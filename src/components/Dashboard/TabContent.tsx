        ...
        <TabsContent value="scheduling-operators" className="w-full space-y-4">
          ...
          <Card className="w-full">
            <CardContent className="p-6">
              ...
              <div className="border rounded-md p-4 bg-muted/10">
                <p className="text-muted-foreground">
                  Operator A has maintained a 98% attendance rate and completed
                  127 units this month, which is 15% above average. Their
                  efficiency score is in the top 10% of all operators.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="border rounded-md p-4 bg-muted/10">
                <p className="text-muted-foreground">
                  ...
                  Quality scores have improved by 7% with a reduction in defect
                  rate from 1.2% to 0.8%.
                </p>
              </div>
            </CardContent>
          </Card>
